...
const NewProduct = () => {
  ...
  console.log("check in New product");

  // User ID (hardcoded as per your request)
  const userId = "Wj2d9mVlwIdC2WEOwhcz9sh4m602";
  ...
  const [newProduct, { isLoading, isError}] = useNewProductsMutation();
